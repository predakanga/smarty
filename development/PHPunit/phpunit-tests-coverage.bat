...
set PHPBIN="C:\wamp\bin\php\php5.3.8\php.exe"
"C:\wamp\bin\php\php5.3.8\php.exe">test_results.txt "C:\wamp\bin\php\php5.3.8\phpunit" --coverage-html coverage --configuration coverage.xml SmartyTests.php
