...
set PHPBIN="C:\wamp\bin\php\php5.2.9-1\.\php.exe"
"C:\wamp\bin\php\php5.2.9-1\.\php.exe">test_results.txt "C:\wamp\bin\php\php5.2.9-1\phpunit" --verbose SmartyTestssingle.php
